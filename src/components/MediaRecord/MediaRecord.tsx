...
import { formatDuration, getSupportedMimeTypes, randomString } from '../../utils/helpers'
...
const MediaRecord = ({ onCloseCamera }: Props) => {
  ...
  const handleCloseCamera = (url: string) => {
    onCloseCamera(url)
  }
    ...
    <div className="container" ref={ref}>
      <div className="webcam-wrapper">
        ...
        <div className="controls">
          ...
          <div className={`actions-wrapper${isRunning ? ' recording' : ''}`} onClick={handleRecordingStatus}>
            {isRunning ? <div className="stop"></div> : <div className="record"></div>}
          </div>
        </div>
      </div>
    </div>
